...
_________________________________________________________ -->
 ...
 _________________________________________________________ -->
                        ...
                        <div class="panel panel-default sidebar-menu with-icons">
                           ...
                           <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                <li class="active"><a href="access1.php">アクセス</a></li>
                    ...
                    <section>
                            ...
                            <div class="col-md-9">
                            <p style="font-size:1.5em; width: 700px; color: #0099FF">- &nbsp; <b>電車の場合</b></p>
                       <p style="font-size:1.1em;"> 神奈川県川崎市麻生区上麻生5-6-5　柿生駅前センター12号（柿生ショッピングセンター2階)
                        小田急線柿生駅南口を出て、徒歩約1分。</p>   
                         <p style="font-size:1.1em; width: 700px;">1. &nbsp; 柿生駅南口を降りましたらバス乗り場に向かって30m直進して下さい。</p>           
                           <P align="center">
                           <img src="img/profile/kakio11.jpg" width="200" height="150" border="0" 
                           ...
                           <br>
                           <br>
                            <p style="font-size:1.1em; width: 700px;">2. &nbsp;薬局のセイジョーの前の通りを左折して下さい。</p>           
                           <P align="center">
                           <img src="img/profile/kakio001.JPG" width="200" height="150" border="0" 
                           style="width: 350px;height: 250px;
                            text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                           ...
                           <br>
                           <p style="font-size:1.1em; width: 700px;">3. &nbsp; バス通りをそのまま50m直進して下さい。</p>           
                           <P align="center">
                           <img src="img/profile/kakio31.jpg" width="200" height="150" border="0" 
                            style="width: 350px;height: 250px;
                            text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                            ...
                            <br>
                           <p style="font-size:1.1em; width: 700px;">4. &nbsp; 交番あるビル2階が弊社の展示室です。</p>           
                           <P align="center">
                           <img src="img/profile/kakio003.JPG" width="200" height="150" border="0"
                           style="width: 350px;height: 250px;
                            text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                            ...
                            <br>
                           <p style="font-size:1.1em; width: 700px;">5. &nbsp; 入ってすぐの階段を登り2階に上がります。</p>           
                           <P align="center">
                           <img src="img/profile/kakio61.jpg" width="200" height="150" border="0" 
                           style="width: 350px;height: 250px;
                            text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                           ...
                           <br>
                           <p style="font-size:1.1em; width: 700px;">6. &nbsp; 2階に上がりましたら左に曲がります。</p>           
                           <P align="center">
                           <img src="img/profile/kakio71.jpg" width="200" height="150" border="0" 
                           style="width: 350px;height: 250px;
                            text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                            ...
                            <br>
                           <p style="font-size:1.1em; width: 700px;">7. &nbsp; こちらが展示室になります。</p>           
                           <P align="center">
                           <img src="img/profile/kakio81.jpg" width="200" height="150" border="0" 
                            style="width: 350px;height: 250px;
                            text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                           ...
                           <p style="font-size:1.5em; width: 700px; color: #0099FF">- &nbsp;<b> 自動車の場合</b></p>
                           <p style="font-size:1.1em;">東名高速道路横浜青葉インターチェンジ、中央高速道路稲城インターチェンジ、東名高速道路東名川崎インターチェンジが最寄りです。<br>
                           -&nbsp;駐車場はありません・・・・・・。<br>
                           -&nbsp;スーパーマルエツ駐車場が台数が多くお勧め、柿生駅前にコインパーキングも御座います。
                          </p>
                         <hr>                                    
                     </div>    
