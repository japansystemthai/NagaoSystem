...
_________________________________________________________ -->
 ...
 _________________________________________________________ -->
                           ...
                           <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="cleaning.php">容器洗浄方法</a>
                                    </li>
                                    <li><a href="urban.php">都市鉱石事業</a>
                                    </li>
                                    <li><a href="decontamination.php">除染作業</a>
                 ...
                 <div id="text-page">
                        ...
                        <!-- /.row -->
                       <h4>&nbsp;セラミックス容器、セラミックスボールの洗浄方法</h4>

                      </div>
                    
                        <div class="row" >
                        <div class="col-md-12" style="border:1.5px solid #BEBEBE;box-shadow: 5px 0px 40px rgba(0,0,0, .2);" >
                           
                                <div class="panel panel-default" style="padding-top: 10px;">
                                   
                                <p style="width:600px; font-size: 1.2em;">
                                1.&nbsp; 一度水で粉砕ボールと容器を濯ぐ。</p>
                                <p style="width:658px; font-size: 1.2em;">
                                2.&nbsp; 使用した粉砕ボールを容器の中に入れ、シリカやアルミナの粉を小さじスプーン1杯分と水をボールのつら付近まで入れる。</p>
                               <p style="width:658px; font-size: 1.2em;">
                               3.&nbsp;傾斜型ボールミルPlanet を中～高速回転で5～10分程度稼動させる。④それでも汚れが落ち切れていない場合は、同じ作業を何度も行う。</p>
                               <p style="width:600px; font-size: 1.2em;">
                               4.&nbsp; または、酸で焼く方法も御座います。</p>
                              <br>
                              <p style="font-size: 1.2em; text-align: center;">★★&nbsp;<b>3次元ボールミル(3次元リアクター)容器の洗浄も、同様。</b>&nbsp;★★</p>
