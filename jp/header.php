                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-5 contact">
                           <p class="hidden-sm hidden-xs"><font size="5"><b>NAGAO SYSTEM</b></font>
</p>
                        ...
                        <div class="col-xs-7">
                            <div class="social">
                              <i class="fa fa-phone"></i>+81-44-954-4486&nbsp;&nbsp;
                               <a href="index.php">日本語</a> / <a href="en/index_en.php">English</a>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" id="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <h5>現在の製品</h5>
                                                        <ul>
                                                             <li><a href="youtube_present.php">Video</a>
                                                            </li>
                                                             <li><a href="show_pdf.php">Documents </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="goodpointsE.php">スーパーポイント</a>
                                                            </li>
                                                            <li><a href="targetE.php">ターゲットと製品</a>
                                                            </li>
                                ...
                                <!-- ========== FULL WIDTH MEGAMENU ================== -->
                               <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">ニュース<b class="caret"></b></a>
                                    <ul class="dropdown-menu">               
                                        <li><a href="exhibitionE.php">イベントスケジュール</a>
                                        </li> 
                                        <li><a href="Newspaper.php">新聞</a>
                                        </li>
                                        <li><a href="torisetsuE.php">テレビ番組放送</a>
                                        </li>
                                        <li><a href="ConferencePresentationE.php">会議のプレゼンテーション</a>
                                        </li>                                         
                                    </ul>
                                </li>
                                 <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                            ...
                                            <li><a href="cleaning.php">クリーニング方法</a>
                                            </li>
                                            <li><a href="urban.php">都市鉱山</a>
                                            </li>
                                            <li><a href="decontamination.php">汚染除去</a>
                                            </li>
