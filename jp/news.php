...
_________________________________________________________ -->
 ...
 _________________________________________________________ -->
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="decontamination.php">除染作業</a>
                                     ...
                                     <li class="active"><a href="news.php">新聞記事</a>
                                    </li>
                                    <li><a href="wanted.php">パートナー</a>
                                    </li>
                 ...
                 <div id="text-page">
                        ...
                        <p class="text-muted text-uppercase mb-small text-right">日本経済新聞社、朝日新聞社、日刊工業新聞社 |  2009年12月18日</p>
                                <h2>3次元ボールミル(3次元リアクター)紹介記事</h2>
                           
                                <blockquote>
                                <ul>
                                    <li style="font-size:1.2em;">日本経済新聞社</li>
                                    <li style="font-size:1.2em;" >朝日新聞社</li>
                                    <li style="font-size:1.2em;">日刊工業新聞社</li>
                                </ul>
                                </blockquote>
                  ...
                  <div class="row portfolio">
                        ...
                        <div class="col-sm-5">
                            <div class="box-image" >
                                <div class="image">
                                    <img src="img/profile/logonew13.jpg" alt="" class="img-responsive" style="height: 380px;" >
                                </div>
                        ...
                        <div class="col-sm-5">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/profile/logonew1.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3>朝日新聞社</h3> 
                        ...
                        <div class="col-sm-5">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/profile/logonew2.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3>日刊工業新聞社</h3> 
                        ...
                        <div class="col-sm-5">
                            <div class="box-image" >
                                <div class="image">
                                    <img src="img/profile/logonew3.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3>Asahi Newspaper</h3> 
                                </div>
                        ...
                        <div class="col-sm-5">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/profile/logonew4.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3>Asahi Newspaper</h3> 
                        ...
                        <div class="col-sm-5">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/profile/logonew5.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3>Nikkan Kogyo Newspaper</h3> 
                                </div>
